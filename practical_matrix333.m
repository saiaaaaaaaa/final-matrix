...
set(gca,'FontSize',10)
figure()
plot(time,u_1_2_2,'b-',time,v_1_2_2,'r--','LineWidth',1.5)%,time,u_1_2_2,'r--'
xlabel('Time(Sec)','Interpreter','latex') 
